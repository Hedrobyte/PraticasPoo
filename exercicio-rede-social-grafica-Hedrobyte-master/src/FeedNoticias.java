...
public class FeedNoticias {
    ...
    public void postarMensagemTexto(String autor, String texto) {
        ...
        // adiciona um novo autor caso ele não exista
    ...
    /**
     * método que retorna uma lista com todos os autores
     */
    ...
    public List<Mensagem> getPublicacoes(String autor) {
        // Cria uma lista de publicações somente-leitura
        List<Mensagem> publicacoes = new ArrayList<>();
        // Adiciona todas as mensagens (pertercentes ao autor) do feed na lista de publicações
